...
{
    /// <summary>
    /// UI representation of a LicenseScriptableObject that can be purchased.
    /// </summary>
    public class UIShopItemLicense : UIShopItem
    {
        /// <summary>
        ...
        public override void Initialize(PurchasableScriptableObject purchasable)
        {
            ...
            LicenseScriptableObject license = purchasable as LicenseScriptableObject;
            if (lockedOverlay != null && !lockedOverlay.activeInHierarchy && !string.IsNullOrEmpty(license.otherRequired))
            {
        ...
        private void OnUpgradePurchase(PurchasableScriptableObject otherPurchasable)
        {
            ...
            LicenseScriptableObject license = purchasable as LicenseScriptableObject;
            if (otherPurchasable.id == license.otherRequired)
                Refresh();
        }
