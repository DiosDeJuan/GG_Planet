...
namespace FLOBUK.StoreSimulator
{
    ...
    public class UIStats : MonoBehaviour
    {
        ...
        void Start()
        {
            ...
            if (dailyData["stolenValue"].AsLong > 0)
                moneySpent.text += "\nPerdidas por robo: " + StoreDatabase.FromLongToStringMoney(dailyData["stolenValue"].AsLong);
            if (dailyData["recoveredValue"].AsLong > 0)
